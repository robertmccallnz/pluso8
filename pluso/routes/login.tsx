    ...
    <>
      ...
      <div class="min-h-screen flex flex-col justify-center bg-gradient-to-br from-base-200 via-base-100 to-base-300">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-base-content/70">
              ...
              <a href="/signup" class="font-medium text-primary hover:text-primary-focus transition-colors">
                Sign up for free
              </a>
            </p>
          </div>
            ...
            <form class="space-y-6" action="/api/auth/login" method="POST">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  />
                  <label for="remember-me" class="ml-2 block text-sm text-base-content/70">
                    Remember me
                  </label>
                </div>
            ...
            <div class="mt-6">
              <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                  <span class="px-2 bg-base-100 text-base-content/70">
                    Or continue with
                  </span>
                </div>
              </div>
        ...
        <div class="mt-8 text-center text-sm text-base-content/70">
          ...
          <a href="/terms" class="font-medium text-primary hover:text-primary-focus transition-colors">
            Terms of Service
          </a>{" "}
          and{" "}
          <a href="/privacy" class="font-medium text-primary hover:text-primary-focus transition-colors">
            Privacy Policy
          </a>
        </div>
      </div>
